...
TEST_CASE("pick items when there are enough items", "Warehouse::pickItems"){
    ...
    bool successful = warehouse.pickItems("Apple", 20);
    REQUIRE(successful);
...
TEST_CASE("pick items when there are not enough items", "Warehouse::pickItems"){
